      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8 md:mb-12">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            ...
            <Button variant="outline" onClick={() => setShowFilters(!showFilters)} className="md:hidden font-sans">
        ...
        {showFilters && (
          <div className="md:hidden mb-6 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
            <h3 className="text-lg font-semibold mb-3 font-sans">Kategoriler</h3>
            <Select
              onValueChange={(value) => {
                if (value === "all") {
            ...
            {selectedCategory && selectedCategory.subcategories && (
              <div className="mt-4">
                <h4 className="text-md font-semibold mb-2 font-sans">Alt Kategoriler</h4>
                <Select
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    {selectedCategory.subcategories.map((subcat) => (
                      <SelectItem key={subcat.id} value={subcat.id} className="font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="hidden lg:block lg:col-span-3 space-y-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border border-gray-200 dark:border-gray-700">
              <h3 className="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4 font-sans">Kategoriler</h3>
                      ...
                      <ul className="pl-4 mt-2 space-y-1 border-l border-gray-200 dark:border-gray-700">
                        <li>
                          <Button
                            ...
                            size="sm"
                            className={`w-full justify-start text-xs font-sans ${!selectedSubcategory ? "font-semibold text-blue-600 dark:text-blue-400" : "text-gray-600 dark:text-gray-400"}`}
                        ...
                        {cat.subcategories.map((subcat) => (
                          <li key={subcat.id}>
                            <Button
                              ...
                              size="sm"
                              className={`w-full justify-start text-xs font-sans ${selectedSubcategory === subcat.id ? "font-semibold text-blue-600 dark:text-blue-400" : "text-gray-600 dark:text-gray-400"}`}
          ...
          <div className="lg:col-span-9">
            {selectedCategory === null && searchTerm === "" ? (
              // Category Grid
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-6 mb-12">
                {categories.map((category) => (
                  ...
                  >
                    <CardHeader className="pb-2">
                      <CardTitle className="text-lg font-semibold group-hover:text-blue-600 font-sans text-wrap">
              ...
              <div className="text-center py-12">
                ...
                {selectedCategory && (
                  <Button onClick={() => handleCategoryClick(null)} className="mt-6 font-sans">
